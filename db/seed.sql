...
-- ==========================================
-- Fuentes:
--   users.json                  → app_user, student
--   carreras.json               → career
--   courses.json                → course
--   docentes.json               → teacher
--   curriculums.json            → curriculum
--   especialidades.json         → specialty
--   curriculum_courses.json     → curriculum_course
--   curriculum_course_specialties.json → curriculum_course_specialty
--   course_prerequisites.json   → course_prerequisite
--   evaluaciones.json           → course_offering, syllabus, assessment
--   secciones.json              → section
--   enrollments.json            → enrollment
--   notas_estudiantes.json      → student_score
--   user_especialidades.json    → student_specialty
-- ==========================================
...
VALUES
  (1,  1, 45),  -- INGENIERÍA DE SOFTWARE II
  (2,  1, 40),  -- APRENDIZAJE DE MÁQUINA
  (3,  1, 38),  -- GESTIÓN DE OPERACIONES
  (4,  1, 63),  -- PROGRAMACIÓN MÓVIL
  (5,  1, 37),  -- SISTEMAS DE INTELIGENCIA EMPRESARIAL
  (6,  1, 35),  -- PROGRAMACIÓN WEB
  (7,  1, 47),  -- GESTIÓN DE PROYECTOS
  (8,  1, 69),  -- COMPUTACIÓN EN LA NUBE
  (9,  1, 50),  -- SEMINARIO DE INVESTIGACIÓN II
  (10, 1, 48),  -- SEMINARIO DE INVESTIGACIÓN I
  (11, 1, 51),  -- GESTIÓN DE SERVICIOS DIGITALES
  (12, 1, 43),  -- SISTEMAS ERP
  (13, 1, 54),  -- INTERNET DE LAS COSAS
  (14, 1, 49),  -- SEGURIDAD DE SISTEMAS
  (15, 1, 55),  -- GESTIÓN DE BASE DE DATOS
  (16, 1, 76),  -- ARQUITECTURA DE SOFTWARE
  (17, 1, 72),  -- ARQUITECTURA EMPRESARIAL
  (18, 1, 59),  -- INGENIERÍA DEL CONOCIMIENTO
  (19, 1, 73),  -- INTERACCIÓN HUMANO COMPUTADORA
  (20, 1, 75),  -- DEVOPS
  (21, 1, 46),  -- PLANEAMIENTO ESTRATÉGICO
  (22, 1, 66),  -- ANALÍTICA CON BIG DATA
...
VALUES
  (1,  1, 1,  1, 1,  4, 'general_studies'),
  (2,  1, 2,  1, 2,  3, 'general_studies'),
  (3,  1, 3,  1, 3,  2, 'general_studies'),
  (4,  1, 4,  1, 4,  3, 'general_studies'),
  (5,  1, 5,  1, 5,  3, 'general_studies'),
  (6,  1, 6,  1, 6,  5, 'general_studies'),
  (7,  1, 7,  2, 1,  3, 'general_studies'),
  (8,  1, 8,  2, 2,  3, 'general_studies'),
  (9,  1, 9,  2, 3,  3, 'general_studies'),
  (10, 1, 10, 2, 4,  3, 'general_studies'),
  (11, 1, 11, 2, 5,  3, 'general_studies'),
  (12, 1, 12, 2, 6,  5, 'general_studies'),
  (13, 1, 13, 3, 1,  3, 'common'),
  (14, 1, 14, 3, 2,  5, 'common'),
  (15, 1, 15, 3, 3,  2, 'common'),
  (16, 1, 16, 3, 4,  4, 'faculty'),
  (17, 1, 17, 3, 5,  4, 'faculty'),
  (18, 1, 18, 3, 6,  4, 'faculty'),
  (19, 1, 19, 4, 1,  4, 'common'),
  (20, 1, 20, 4, 2,  3, 'common'),
  (21, 1, 21, 4, 3,  3, 'faculty'),
  (22, 1, 22, 4, 4,  3, 'common'),
  (23, 1, 23, 4, 5,  4, 'faculty'),
  (24, 1, 24, 4, 6,  4, 'faculty'),
  (25, 1, 25, 5, 1,  4, 'faculty'),
  (26, 1, 26, 5, 2,  4, 'common'),
  (27, 1, 27, 5, 3,  4, 'faculty'),
  (28, 1, 28, 5, 4,  3, 'faculty'),
  (29, 1, 29, 5, 5,  4, 'faculty'),
  (30, 1, 30, 5, 6,  4, 'faculty'),
  (31, 1, 31, 6, 1,  3, 'faculty'),
  (32, 1, 32, 6, 2,  4, 'faculty'),
  (33, 1, 33, 6, 3,  3, 'faculty'),
  (34, 1, 34, 6, 4,  4, 'faculty'),
  (35, 1, 35, 6, 5,  3, 'faculty'),
  (36, 1, 36, 6, 6,  3, 'faculty'),
  (37, 1, 37, 7, 1,  4, 'faculty'),
  (38, 1, 38, 7, 2,  3, 'faculty'),
  (39, 1, 39, 7, 3,  4, 'faculty'),
  (40, 1, 40, 7, 4,  4, 'faculty'),
  (41, 1, 41, 7, 5,  4, 'faculty'),
  (42, 1, 42, 8, 1,  3, 'faculty'),
  (43, 1, 43, 8, 2,  3, 'faculty'),
  (44, 1, 44, 8, 3,  3, 'faculty'),
  (45, 1, 45, 8, 4,  4, 'faculty'),
  (46, 1, 46, 9, 1,  3, 'faculty'),
  (47, 1, 47, 9, 2,  3, 'common'),
  (48, 1, 48, 9, 3,  4, 'faculty'),
  (49, 1, 49, 9, 4,  4, 'faculty'),
  (50, 1, 50, 10, 1, 4, 'faculty'),
  (51, 1, 51, 10, 2, 4, 'faculty'),
  (52, 1, 52, 10, 3, 4, 'faculty'),
  (53, 1, 53, 6,  7, 3, 'elective'),
  (54, 1, 54, 6,  8, 3, 'elective'),
  (55, 1, 55, 6,  9, 3, 'elective'),
  (56, 1, 56, 6,  10, 3, 'elective'),
  (57, 1, 57, 7,  6, 3, 'elective'),
  (58, 1, 58, 7,  7, 3, 'elective'),
  (59, 1, 59, 7,  8, 3, 'elective'),
  (60, 1, 60, 7,  10, 5, 'elective'),
  (61, 1, 61, 7,  11, 3, 'elective'),
  (62, 1, 62, 8,  5, 3, 'elective'),
  (63, 1, 63, 8,  6, 3, 'elective'),
  (64, 1, 64, 8,  7, 3, 'elective'),
  (65, 1, 65, 9,  5, 3, 'elective'),
  (66, 1, 66, 9,  6, 3, 'elective'),
  (67, 1, 67, 9,  7, 3, 'elective'),
  (68, 1, 68, 9,  8, 3, 'elective'),
  (69, 1, 69, 10, 4, 3, 'elective'),
  (70, 1, 70, 10, 5, 3, 'elective'),
  (71, 1, 71, 10, 6, 3, 'elective'),
  (72, 1, 72, 10, 7, 3, 'elective'),
  (73, 1, 73, 10, 8, 3, 'elective'),
  (74, 1, 74, 10, 9, 3, 'elective'),
  (75, 1, 75, 10, 10, 3, 'elective'),
  (76, 1, 76, 10, 11, 3, 'elective'),
...
-- ==========================================
-- INGENIERÍA DE SOFTWARE II (syllabus_id=1, course_offering_id=1)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- APRENDIZAJE DE MÁQUINA (syllabus_id=2, course_offering_id=2)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- GESTIÓN DE OPERACIONES (syllabus_id=3, course_offering_id=3)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- PROGRAMACIÓN MÓVIL (syllabus_id=4, course_offering_id=4)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- SISTEMAS DE INTELIGENCIA EMPRESARIAL (syllabus_id=5, course_offering_id=5)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- GESTIÓN DE PROYECTOS (syllabus_id=7, course_offering_id=7)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- COMPUTACIÓN EN LA NUBE (syllabus_id=8, course_offering_id=8)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- SEMINARIO DE INVESTIGACIÓN II (syllabus_id=9, course_offering_id=9)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- SEMINARIO DE INVESTIGACIÓN I (syllabus_id=10, course_offering_id=10)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- GESTIÓN DE SERVICIOS DIGITALES (syllabus_id=11, course_offering_id=11)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- SISTEMAS ERP (syllabus_id=12, course_offering_id=12)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- INTERNET DE LAS COSAS (syllabus_id=13, course_offering_id=13)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- SEGURIDAD DE SISTEMAS (syllabus_id=14, course_offering_id=14)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- GESTIÓN DE BASE DE DATOS (syllabus_id=15, course_offering_id=15)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- ARQUITECTURA DE SOFTWARE (syllabus_id=16, course_offering_id=16)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- ARQUITECTURA EMPRESARIAL (syllabus_id=17, course_offering_id=17)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- INGENIERÍA DEL CONOCIMIENTO (syllabus_id=18, course_offering_id=18)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- INTERACCIÓN HUMANO COMPUTADORA (syllabus_id=19, course_offering_id=19)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- DEVOPS (syllabus_id=20, course_offering_id=20)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- PLANEAMIENTO ESTRATÉGICO (syllabus_id=21, course_offering_id=21)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- ANALÍTICA CON BIG DATA (syllabus_id=22, course_offering_id=22)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- ARQUITECTURA DE TI (syllabus_id=23, course_offering_id=23)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- ANÁLISIS Y DISEÑO DE ALGORITMOS (syllabus_id=24, course_offering_id=24)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- PROPUESTA DE INVESTIGACIÓN (syllabus_id=25, course_offering_id=25)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
-- SISTEMAS DISTRIBUIDOS (syllabus_id=26, course_offering_id=26)
INSERT INTO assessment (id, syllabus_id, assessment_type_id, code, name, week_number, weight)
VALUES
...
VALUES
  (1,  1, 7,  'course',         1,  NULL),
  (2,  1, 11, 'course',         6,  NULL),
  (3,  1, 12, 'course',         6,  NULL),
  (4,  1, 14, 'course',         12, NULL),
  (5,  1, 15, 'course',         9,  NULL),
  (6,  1, 19, 'course',         12, NULL),
  (7,  1, 20, 'course',         14, NULL),
  (8,  1, 21, 'course',         13, NULL),
  (9,  1, 22, 'course',         15, NULL),
  (10, 1, 23, 'course',         17, NULL),
  (11, 1, 23, 'course',         18, NULL),
  (12, 1, 24, 'course',         16, NULL),
  (13, 1, 25, 'course',         19, NULL),
  (14, 1, 26, 'course',         20, NULL),
  (15, 1, 27, 'course',         24, NULL),
  (16, 1, 28, 'course',         15, NULL),
  (17, 1, 29, 'course',         23, NULL),
  (18, 1, 30, 'course',         23, NULL),
  (19, 1, 31, 'course',         26, NULL),
  (20, 1, 32, 'course',         27, NULL),
  (21, 1, 33, 'course',         21, NULL),
  (22, 1, 34, 'course',         29, NULL),
  (23, 1, 35, 'course',         29, NULL),
  (24, 1, 36, 'course',         22, NULL),
  (25, 1, 37, 'course',         30, NULL),
  (26, 1, 38, 'course',         31, NULL),
  (27, 1, 39, 'course',         30, NULL),
  (28, 1, 40, 'course',         25, NULL),
  (29, 1, 41, 'course',         32, NULL),
  (30, 1, 42, 'course',         33, NULL),
  (31, 1, 43, 'course',         38, NULL),
  (32, 1, 44, 'course',         36, NULL),
  (33, 1, 45, 'course',         39, NULL),
  (34, 1, 47, 'course',         44, NULL),
  (35, 1, 48, 'course',         42, NULL),
  (36, 1, 49, 'course',         41, NULL),
  (37, 1, 50, 'course',         48, NULL),
  (38, 1, 52, 'course',         47, NULL),
  (39, 1, 53, 'completed_cycle', NULL, 5),
  (40, 1, 54, 'completed_cycle', NULL, 5),
  (41, 1, 55, 'completed_cycle', NULL, 5),
  (42, 1, 57, 'completed_cycle', NULL, 5),
  (43, 1, 57, 'course',         34, NULL),
  (44, 1, 58, 'completed_cycle', NULL, 5),
  (45, 1, 58, 'course',         32, NULL),
  (46, 1, 59, 'completed_cycle', NULL, 5),
  (47, 1, 60, 'course',         56, NULL),
  (48, 1, 61, 'course',         56, NULL),
  (49, 1, 62, 'completed_cycle', NULL, 5),
  (50, 1, 62, 'course',         40, NULL),
  (51, 1, 63, 'completed_cycle', NULL, 5),
  (52, 1, 63, 'course',         35, NULL),
  (53, 1, 64, 'completed_cycle', NULL, 5),
  (54, 1, 64, 'course',         41, NULL),
  (55, 1, 65, 'completed_cycle', NULL, 5),
  (56, 1, 66, 'completed_cycle', NULL, 5),
  (57, 1, 66, 'course',         37, NULL),
  (58, 1, 67, 'completed_cycle', NULL, 5),
  (59, 1, 68, 'completed_cycle', NULL, 5),
  (60, 1, 68, 'course',         45, NULL),
  (61, 1, 69, 'completed_cycle', NULL, 5),
  (62, 1, 70, 'completed_cycle', NULL, 5),
  (63, 1, 71, 'completed_cycle', NULL, 5),
  (64, 1, 72, 'completed_cycle', NULL, 5),
  (65, 1, 72, 'course',         46, NULL),
  (66, 1, 73, 'completed_cycle', NULL, 5),
  (67, 1, 74, 'completed_cycle', NULL, 5),
